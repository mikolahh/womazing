...
$args = array(
	...
	'menu_title'                => esc_html__( 'Правим контент', 'your-textdomain-here' ),
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Redux устанавливает для вас глобальную переменную. Чтобы получить доступ к любой из ваших сохраненных опций из вашего кода, вы можете использовать глобальную переменную: $%1$s', 'your-textdomain-here' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'home',
		'desc'             => esc_html__( 'Редактируем контент на главной странице', 'your-textdomain-here' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
	)
);
require_once get_template_directory() . "/inc/redux-components/home/top-section.php";
require_once get_template_directory() . "/inc/redux-components/home/new-col-section.php";
require_once get_template_directory() . "/inc/redux-components/home/advantages-section.php";
require_once get_template_directory() . "/inc/redux-components/home/dream-team-section.php";
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'about',
		'desc'             => esc_html__( 'Редактируем контент на странице "О бренде"', 'your-textdomain-here' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
	)
);

require_once get_template_directory() . "/inc/redux-components/about/about-first-section.php";
require_once get_template_directory() . "/inc/redux-components/about/about-second-section.php";
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'footer',
		'desc'             => esc_html__( 'Редактируем контент подвала сайта', 'your-textdomain-here' ),
		'customizer_width' => '400px',
...
require_once get_template_directory() . "/inc/redux-components/footer/footer-cprt.php";
require_once get_template_directory() . "/inc/redux-components/footer/footer-social.php";

// Контакты
require_once get_template_directory() . "/inc/redux-components/contact.php";
